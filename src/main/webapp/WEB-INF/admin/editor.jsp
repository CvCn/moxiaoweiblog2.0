...
<title>添加博客-moxiaowei.com</title>
<style>
body {
	...
	<div class="container" id="editor">
		<div style="margin-bottom: 2%;">
			<div class="form-group">
				<h4>
					标题 <small>（20字以内）</small>
				</h4>
				<div class="form-group input-group">
					<input type="text" class="form-control" id="title"> <span class="input-group-btn">
...
<script>
	$(function() {
		...
		<%--
		$.post("/user/getTempAdd", function(blog) {
...
--%>
		...
		function formatData(longTypeDate) {
			...
			return date.getFullYear() + "-" + formatCol(date.getMonth() + 1)
