...
public class UserServiceImpl implements UserService {
	...
	public boolean addGrow(String content) {
		return this.growMapper.insGrow(content) > 0;
	}

	@Override
	public boolean addBlog(Blog blog) {
		return this.blogMapper.addBlog(blog) > 0;
	}

	@Override
	public boolean delBlog(long id) {
		return this.blogMapper.delBlog(id) > 0;
	}
	...
	public boolean noticeDel() {
		long del = this.jedisClientSingle.del(this.NOTICE_STR);
		return del <= 0;
	}
